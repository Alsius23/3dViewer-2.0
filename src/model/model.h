...
namespace s21 {
     ...
     * а также для выполнения различных операций над ней, таких как вращение, масштабирование и перемещение.
     */
    class Model {
        public:
            /**
             ...
             *
             * Читает данные о вершинах и гранях из указанного файла и заполняет ими модель.
             *
             ...
             *
             * Увеличивает или уменьшает размеры модели в соответствии с указанным коэффициентом.
             *
